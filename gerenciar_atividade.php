...
<div class="box">
    <span class="titulo">Lista de Atividade Para Avaliação</span> 

    <?php
    $retorno_atividade = new Atividade();
    $retorno = $retorno_atividade->listarAtividadeProfessor($usuario->id_professor, "0");
    if (!$retorno):
